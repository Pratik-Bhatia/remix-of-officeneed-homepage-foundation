    ...
    products: [
      {
        ...
        url: "/products/signature-executive-gift-hamper",
        price: "₹4,999",
      },
    ],
  },
    ...
    products: [
      {
        ...
        url: "/products/hardbound-executive-notebook",
        price: "₹1,299",
      },
      {
        id: "fp-metal-pen",
        ...
        url: "/products/brushed-metal-rollerball-pen",
        price: "₹899",
      },
    ],
    shopTheLookUrl: "/products?category=Office+Supplies",
  },
  {
    ...
    products: [
      {
        ...
        url: "/products/silent-wireless-mouse",
        price: "₹2,199",
      },
      {
        id: "fp-keyboard",
        ...
        url: "/products/low-profile-wireless-keyboard",
        price: "₹3,499",
      },
      {
        ...
        url: "/products/minimal-desk-accessory-set",
        price: "₹1,499",
      },
    ],
    shopTheLookUrl: "/products?category=Hardware+%26+IT",
  },
  {
    ...
    products: [
      {
        ...
        url: "/products/eastern-oud-perfume-100ml",
        price: "₹5,499",
      },
    ],
  },
