...
- [x] Headless Shopify edge cases: stock errors, tab sync, discount codes, variant links + share previews, in-site order details, removed-product cleanup, expired sign-in, checkout UTM handoff
