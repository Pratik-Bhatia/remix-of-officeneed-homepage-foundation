...
// I'll just write a cleaner regex to replace the entire RULES array
const fullRules = `const RULES: Rule[] = [
...
content = content.replace(/const RULES: Rule\[\] = \[[\s\S]*?\];/, fullRules);

fs.writeFileSync(path, content);
console.log("Fixed rules array duplicates.");
